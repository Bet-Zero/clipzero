...
async function main() {
  ...
  const fakeUrl =
    "https://videos.nba.com/nba/pbp/media/2026/04/15/0052500131/7/totally-fake-nonexistent-uuid_960x540.mp4";
  ...
  const oldSeasonUrl =
    "https://videos.nba.com/nba/pbp/media/2024/12/25/0022400428/7/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee_960x540.mp4";
  try {
    r = await axios.head(oldSeasonUrl, { timeout: 10000 });
    console.log(
      "Old season fake - Status:",
      r.status,
      "ETag:",
      r.headers.etag,
      "Size:",
