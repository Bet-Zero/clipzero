...
async function main() {
  ...
  try {
    ...
    console.log("Response structure:", JSON.stringify(r.data, null, 2).slice(0, 2000));
  } catch (e) {
  ...
  try {
    ...
    const testUrl = "https://videos.nba.com/nba/pbp/media/2026/04/15/0052500131/7/ca4454f8-95aa-c64c-ec48-524ad4617825_960x540.mp4";
    const head = await axios.head(testUrl, { timeout: 10000 });
    console.log("videos.nba.com ETag:", head.headers.etag);
    console.log("videos.nba.com Content-Length:", head.headers["content-length"]);
  } catch (e) {
